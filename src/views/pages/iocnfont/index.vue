<!--
 * @Author: Vane
 * @Date: 2021-05-30 00:44:20
 * @LastEditTime: 2021-05-30 00:58:12
 * @LastEditors: Vane
 * @Description: 
 * @FilePath: \vue-admin\src\views\pages\iocnfont\index.vue
-->
<template>
		...
		<el-card shadow="hover" :header="`iconfont 字体图标(自动载入)：${sheetsIconList.length}个`">
			<el-row class="iconfont-row">
				<el-col :xs="12" :sm="8" :md="6" :lg="4" :xl="2" v-for="(v, k) in sheetsIconList" :key="k">
					<div class="iconfont-warp" @click="(e) => onCopyClick(e, v)">
