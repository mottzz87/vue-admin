		...
		children: [
				...
				children: [
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-caret-left',
						},
						children: [
							{
								...
								meta: {
									...
									isIframe: false,
									auth: ['admin', 'test'],
									icon: 'iconfont ant-icon-file-copy',
								},
							},
							{
					...
					},
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-caret-right',
						},
						children: [
							{
			...
			},
			{
				...
				meta: {
					...
					isIframe: false,
					auth: ['admin', 'test'],
					icon: 'iconfont ant-icon-appstore',
				},
				children: [
					{
						path: '/menu/menu1',
			...
			},
			{
				...
				meta: {
					...
					isIframe: false,
					auth: ['admin', 'test'],
					icon: 'iconfont ant-icon-dropbox',
				},
				children: [
					{
						path: '/fun/tagsView',
					...
					},
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-pic-left',
						},
					},
					{
						path: '/fun/cropper',
					...
					},
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-apartment',
						},
					},
					{
						path: '/fun/qrcode',
					...
					// 		isIframe: false,
					// 		auth: ['admin', 'test'],
					// 		icon: 'iconfont ant-icon-location',
					// 	},
					// },
					{
						path: '/fun/printJs',
				...
				children: [
					...
					},
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-insertrowbelow',
						},
					},
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-insertrowabove',
						},
					},
					{
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-alibaba',
						},
					},
					{
						path: '/pages/steps',
						...
						meta: {
							...
							isIframe: false,
							auth: ['admin', 'test'],
							icon: 'iconfont ant-icon-step-forward',
						},
					},
					{
						path: '/pages/waves',
			...
			},
			{
				...
				meta: {
					...
					isIframe: false,
					auth: ['admin', 'test'],
					icon: 'iconfont ant-icon-linechart',
				},
			},
			{
				path: '/personal',
			...
			},
			{
				...
				meta: {
					...
					isIframe: false,
					auth: ['admin', 'test'],
					icon: 'iconfont ant-icon-appstoreadd',
				},
			},
			{
				path: '/link',
			...
			},
			{
				...
				meta: {
					...
					isLink: 'https://v3.vuejs.org/guide/introduction.html#what-is-vue-js',
					isHide: false,
					isKeepAlive: false,
					isAffix: false,
					isIframe: true,
					auth: ['admin'],
					icon: 'iconfont ant-icon-group',
				},
			},
		],
	},
